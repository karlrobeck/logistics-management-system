...
export const generatedSchema = {
  ...
  mutation: {
    ...
    createCrmCampaign: {
      __type: "CrmCampaignNode!",
      __args: { createCrmCampaign: "CreateCrmCampaignInput!" },
    },
    ...
    createCrmCompany: {
      __type: "CrmCompanyNode!",
      __args: { payload: "PayloadInput_81!" },
    },
    createCrmContact: {
      __type: "CrmContactNode!",
      __args: { payload: "PayloadInput_83!" },
    },
    ...
    register: { __type: "Register!", __args: { payload: "PayloadInput_85!" } },
    updateCrmCampaign: {
      __type: "CrmCampaignNode!",
    ...
    updateCrmCompany: {
      __type: "CrmCompanyNode!",
      __args: { id: "String!", payload: "PayloadInput_82!" },
    },
    updateCrmContact: {
      __type: "CrmContactNode!",
      __args: { id: "String!", payload: "PayloadInput_84!" },
    },
...
export interface Mutation {
  ...
  createCrmCampaign: (args: {
    createCrmCampaign: CreateCrmCampaignInput;
  }) => CrmCampaignNode;
  createCrmCampaignContact: (args: {
    payload: PayloadInput_60;
  }) => CrmCampaignContactNode;
  createCrmCase: (args: { payload: PayloadInput_78 }) => CrmCaseNode;
  createCrmCompany: (args: { payload: PayloadInput_81 }) => CrmCompanyNode;
  createCrmContact: (args: { payload: PayloadInput_83 }) => CrmContactNode;
  ...
  register: (args: { payload: PayloadInput_85 }) => Register;
  ...
  updateCrmCompany: (args: {
    id: ScalarsEnums["String"];
    payload: PayloadInput_82;
  }) => CrmCompanyNode;
  updateCrmContact: (args: {
    id: ScalarsEnums["String"];
    payload: PayloadInput_84;
  }) => CrmContactNode;
